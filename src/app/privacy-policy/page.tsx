...
const PrivacyPolicyPage = () => {
 ...
 <li>Comply with legal obligations.</li>
        ...
        <h2 className="mb-6 mt-6">Sharing Your Information</h2>
        <p>
        ...
        <h2 className="mb-6 mt-6">Data Security</h2>
        <p>
        ...
        <h2 className="mb-6 mt-6">Your Choices</h2>
        <p>
        ...
        <h2 className="mb-6 mt-6">Changes to This Policy</h2>
        <p>
          We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page.
        </p>
        <h2 className="mb-6 mt-6">Contact Us</h2>
        <p>
